...
require('./go-live-routes')(app);
const {scanFollowups}=require('./followup-engine');

const port = Number(process.env.PORT || 3000);
const server = app.listen(port, () => {
  console.log(`Growth Desk revenue, delivery, production, document intelligence, follow-up, acquisition, activation and go-live checks ready at http://localhost:${port}`);
